...
<div class="content">
	...
	<div class="chanpina">
		<div class="biaot4">
			<?php echo $CATEGORYS[$catid]['catname'];?><a href="<?php echo APP_PATH;?>index.php?m=content&c=index&a=lists&catid=48" style="display: block;float: right;font-size: 16px;color:#1d90c7">查看更多>></a>
		</div>
		<div class="chanpina1">
			<p><?php echo $CATEGORYS[$catid]['description'];?></p>
			<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=a87ed34d126fc2f536a93d318bf237bc&action=position&posid=54&order=listorder+DESC&num=6\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'54','order'=>'listorder DESC','limit'=>'6',));}?> 
			<ul>
