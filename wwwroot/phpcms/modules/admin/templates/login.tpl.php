...
<style type="text/css">
	...
	.login_iptbox{bottom:70px;_bottom:72px;color:#FFFFFF;font-size:12px;height:30px;left:50%;
...
<body onload="javascript:document.myform.username.focus();" style="background: url(<?php echo IMG_PATH?>admin_img/backgroud.jpg);
background-size:100% auto;background-repeat: no-repeat;background-color:#e8faff;">
