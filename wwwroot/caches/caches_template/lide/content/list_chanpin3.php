...
<div class="content">
	...
	<div class="chanpina">
		<div class="biaot4">
			<?php echo $CATEGORYS[$catid]['catname'];?><a href="<?php echo APP_PATH;?>index.php?m=content&c=index&a=lists&catid=50" style="display: block;float: right;font-size: 16px;color:#1d90c7">查看更多>></a>
		</div>
		<div class="chanpina1">
